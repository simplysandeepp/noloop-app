-- CreateEnum
CREATE TYPE "TenantType" AS ENUM ('INSURER', 'HOSPITAL');

-- CreateEnum
CREATE TYPE "Role" AS ENUM ('PLATFORM_ADMIN', 'HOSPITAL_ADMIN', 'INSURER_ADMIN', 'HOSPITAL_STAFF', 'INSURER_ADJUDICATOR', 'PATIENT');
